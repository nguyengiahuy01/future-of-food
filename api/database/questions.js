module.exports = [
  {
    id: 1,
    question: "Die Insel versucht, sich auf den Entwicklungsweg der Gesellschaft und Wirtschaft zu einigen und holt die Meinungen der Bewohner ein. Welcher Weg sollte eingeschlagen werden?",
  ...
  },
  {
    ...
    explanation: "Eine industrielle Landwirtschaft hat den Vorteil, dass sie deutlich ertragreicher ist, als die ökologische Landwirtschaft. Allerdings ist diese weitaus umwelt- und tierfreundlicher.",
    group: 1,
    answers: {
      0: {
      ...
      1: {
        label: "Für den Konsumenten teurere Landwirtschaft mit weniger Erträgen, allerdings umweltschonender",
  ...
  {
    id: 5,
    question: "Die Bewohner der Insel müssen sich in einem gemeinsamen Treffen darüber einigen, in was in nächste Zeit mehr investiert werden soll.",
    explanation: "Die Umstellung auf eine Ernährung ohne tierische Produkte hat einen sehr viel größeren positiven Einfluss auf die Umwelt, da Treibhausgase stark reduziert werden und Ackerflächen anders genutzt werden könnten. Die Verbesserung der Technologien ist zwar hilfreich und darf nicht vernachlässigt werden, aber eine nachhaltige Ernährungsumstellung ist entscheidend für eine bessere Umwelt.",
    group: 4,
    answers: {
      0: null,
      1: {
  ...
  },
  {
    ...
    explanation: "Eine effizientere Nutzung von Frischwasser hat einen sehr positiven Einfluss auf die Landwirtschaft. Durch verbesserte Wasserbecken und eine Regulierung des Wasserverbrauchs, kann z.B. Überwässerung reduziert werden und die Felder besser genährt.",
    group: 6,
    answers: {
      0: {
  ...
  },
  {
    ...
    explanation: "Hülsenfrüchte haben nachweislich weniger negativen Einfluss auf die Umwelt als Obst und Gemüse. Zwar brauchen sie mehr Ackerfläche, dafür aber viel weniger Pflege, wie z.B. Düngung, und sind sehr viel nährstoffreicher.",
    group: 3,
    answers: {
      0: null,
      1: {
  ...
  {
    id: 11,
    question: "Um die Zukunft besser gestalten zu können, muss darüber entschieden werden, wie die Umweltbelastungen am besten minimiert werden können.",
    ...
    },
      {
      ...
      },
        {
        ...
        },
          {
            ...
            explanation: "Wir leben alle auf einem Planeten und selbst Probleme am anderen Ende der Welt betreffen uns. Es ist wichtig auch in Entwicklungsländern Aufklärungskampagnen anzubieten, über seinen eigenen Tellerrand hinauszuschauen und mit gutem Vorbild voranzugehen.",
            group: 0,
            answers: {
              0: {
          ...
          },
            {
            ...
            },
              {
                ...
                answers: {
                  0: {
                    label: "Brennholz",
                    explanation: "Bei der Verbrennung von Holz verbindet sich Kohlenstoff mit Sauerstoff aus der Atmosphäre und bildet Kohlendioxid."
                    },
                  1: {
                    label: "Öl und Gas",
